...
DESKFILE  = assets/wayclicker.desktop

debpkgdir="./${PKG_DIR}/deb/package"
appimgdir="${PKG_DIR}/AppImage/WayClicker.AppDir"
...
version:
	...
	@echo "static const char *WAYCLICKER_VERSION = \"v${VERSION}\";" >> ${VERSION_HEADER}
...
install: release
	...
	@sudo install -Dm 755 ./${DESKFILE} /usr/share/applications/wayclicker.desktop
	@sudo install -Dm 644 ./assets/icon.png /usr/share/pixmaps/${BINNAME}.png
	@echo "Installed WayClicker"

.PHONY: uninstall
uninstall:
	@sudo rm /usr/bin/${BINNAME}
	@sudo rm /usr/share/applications/wayclicker.desktop
	@sudo rm /usr/share/pixmaps/${BINNAME}.png
	@echo "Uninstalled WayClicker :("
...
deb: release
	...
	@install -Dm 644 ./${DESKFILE} ${debpkgdir}/usr/share/applications/wayclicker.desktop
...
appimg: release
	...
	@install -Dm 755 ./${DESKFILE} ${appimgdir}/wayclicker.desktop
	@install -Dm 755 ./${PKG_DIR}/AppImage/AppRun ${appimgdir}/AppRun
	@install -Dm 644 ./assets/icon.png ${appimgdir}/${BINNAME}.png
	@cd ${PKG_DIR}/AppImage; appimagetool ./WayClicker.AppDir; mv *.AppImage ${BINNAME}_${VERSION}_${TARGET_ARCH}.AppImage
